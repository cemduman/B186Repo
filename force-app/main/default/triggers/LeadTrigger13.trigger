trigger LeadTrigger13 on Lead (/*after insert, after update : those don't work */ before insert, before update){
    //after dml operations: records are read only....
    ...
    for(Lead w : Trigger.new){
        ...
        w.Industry = 'Banking'; //you cannot do another change in inserted and updated records in TRIGGER 
                                //they are read only
