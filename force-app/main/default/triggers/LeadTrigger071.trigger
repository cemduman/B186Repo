trigger LeadTrigger071 on Lead (before update) {
    ...
    if(Trigger.isBefore && Trigger.isUpdate){
        ...
        for(Lead w : Trigger.new){
            ...
            System.debug('New Lastname of the Lead: ' + w.FirstName + ' ' + w.LastName);
            System.debug('Old Lastname of the Lead: ' + Trigger.oldMap.get(w.Id).FirstName + ' ' + Trigger.oldMap.get(w.Id).LastName);
